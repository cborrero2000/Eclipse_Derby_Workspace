...
public class StatementFinder {
	 ...
	 */
	public String nextStatement(LocalizedOutput out, boolean fileInput) {
		...
		state = IN_STATEMENT;
		if ((isDBConnected == false) && (fileInput == false)) {
			isDBConnected = true;
			statement = new StringBuffer("connect 'jdbc:derby://localhost/MyDatabase'");
